...
<body>
	...
	<div>
		...
		<form action="" method="post" onSubmit="return checkValid()" name="mainform">
			...
			<p>
				<label for="url_suffix">1. Preferred URL</label>
